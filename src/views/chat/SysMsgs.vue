    ...
    <div class="m-article-main p-sysmsgs">
      <group class="u-list-d">
        ...
        <template v-for="msg in msgList">
          ...
          >
            <!--<img class="icon" slot="icon" width="24" src="../../assets/images/gantan.png">-->
          ...
          >
            <img class="icon" slot="icon" width="24" src="@/assets/images/gantan.png">
            <span class="u-tag-del" :class="{active: deleteIdServer === msg.idServer}"></span>
          </cell>
        </template>
      </group>
...
export default {
  ...
  computed: {
    ...
    customSysMsgs () {
        console.log(this.$store.state.customSysMsgs)
      let customSysMsgs = this.$store.state.customSysMsgs.filter(msg => {
        if (msg.scene === 'p2p') {
          ...
          msg.avatar = '@/assets/images/gantan.png'
            console.log(msg)
          return msg
