<template>
  <div class='g-inherit m-article p-teaminvite g-window'>
...
export default {
  ...
  methods: {
    ...
    addMembers() {
      ...
      const _this = this;
      _this.$vux.loading.show({text:"创建中"})
        ...
        this.$store.dispatch('delegateTeamFunction',{
          ...
          options: {
            ...
            accounts: accounts,
              ...
              _this.$vux.loading.hide();
              setTimeout(()=>{
               this.$router.push({path:`/chat/team-${obj.team.teamId}`})
              },20)
