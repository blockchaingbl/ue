  ...
  <div class="m-chat-editor" @click="hideRobotList">
    ...
    <div class="m-chat-editor-main" :class="{robot:isRobot}">
      <span class="u-editor-input">
        <textarea autofocus v-model="msgToSent" @focus='onInputFocus'></textarea>
      </span>
      <span class="u-editor-icons">
        ...
        <!--<span v-if='advancedTeam' class="u-editor-send u-editor-receipt"></span>-->
...
export default {
  ...
  methods: {
    sendTextMsg () {
      if (this.invalid) {
        this.$vux.toast.text(this.invalidHint)
        return
      }
      ...
      {
        this.$http.post('/api/app.user/nim/send_to_society',{type:0,text:this.msgToSent})
          .then(res => {
