<template lang="html">
    <div :id="page_name">
        <x-header :left-options="{showBack: true,backText:'',preventGoBack:true}" :right-options="{showMore: false}" @on-click-back="goback">{{page_title}}
        ...
        <popup v-model="tx_detail" height="100%" v-transfer-dom>
            <div class="tx_detail">
            ...
            open_scan(){
                ...
                window.js_qr_code_scan = function(qr_code){
                    if(qr_code.substr(0,2)=="0x")
                    {
                        ...
                        var path = "/wallet/send/"+coin_type+"?address="+qr_code;
