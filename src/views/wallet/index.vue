<template lang="html">
    <div :id="page_name">
        <pull-to :top-load-method="refresh" :is-bottom-bounce="false" :is-top-bounce="ontop"  style="z-index: 0">
            <x-header :left-options="{showBack: true,backText:'',preventGoBack:true}" :right-options="{showMore: false}" @on-click-back="goback"  style="z-index:1;">{{page_title}}
            ...
            <div class="wallet-box"  v-show="!this.$store.state.balance_loading">
                <router-link  class="item flex-box vux-1px-b"  v-for="(property, index) in this.$store.state.properties" :key="index" :to="'/wallet/detail/'+property.type">
                    <div class="item-img">
                        <!--  <img :src="" alt=""> -->
                ...
                <scroller @on-scroll-bottom="onScrollBottom" height="-52" lock-x ref="scrollerEvent" v-if="token_lists.length>0">
                    <div class="task-block">
                        <div class="item flex-box" v-for="token in token_lists">
                            ...
                            <div class="item-decs flex-box" v-if="!isShowSearch">
...
<script>
    import { TransferDom, XHeader,Actionsheet,Cell,Badge,LoadMore,Popup,Radio,XButton,Box,Scroller,Divider,InlineLoading,InlineXSwitch,Search,Qrcode} from 'vux';
