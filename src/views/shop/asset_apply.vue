    ...
    <div class="page-grant">
        <div v-if="!loading">
            <div class="candy-basic-opera">
                ...
                <popup-radio title="请选择有何资产要变现" :options="resource" v-model="source">
            ...
            <box class="grant-btn-box" gap="0 0">
                <x-button type="primary" style="border-radius:0;height:2.875rem;font-size:0.875rem;" @click.native="order">确认</x-button>
            </box>
        </div>
        <div v-transfer-dom>
    ...
    export default {
        ...
        methods: {
            order(){
                ...
                this.$http.post('api/app.apply/credit/apply_asset',form).then(res=>{
                    if(res.errcode==0)
                    {
