    ...
    <div class="page-grant">
        ...
        <div v-if="!loading">
            <div class="candy-basic-opera">
                ...
                <popup-radio title="请选择有何资产要变现" :options="resource" v-model="source" readonly>
                    <p slot="popup-header" class="vux-1px-b grant-coin-slot">请选择有何资产要变现</p>
                </popup-radio>
                ...
                <popup-radio title="接受方式" :options="accepts_ways" v-model="accepts_way" readonlycardorder>
...
import { Datetime, Loading,LoadMore,PopupRadio, TransferDomDirective as TransferDom,dateFormat } from 'vux'
    export default {
        ...
        methods: {
            getDetail(){
                const _this = this;
                this.$http.post('api/app.apply/credit/asset_detail',{id:this.$route.params.id}).then(res=>{
                    if(res.errcode==0)
                    {
