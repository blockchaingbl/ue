<template lang="html">
    <div :id="page_name">
        <x-header :left-options="{showBack: true,backText:''}" class="inter_wallet_header">{{page_title}}</x-header>
        ...
        <box gap="20px 10px" style="text-align: center;">
            <router-link to="/wallet_international/create">创建钱包</router-link>
        </box>
    </div>
</template>
<script>
                                ...
                                if(res.error>0){
                                    ...
                                    AlertModule.show({
                                        ...
                                        onHide () {
                                            ...
                                            router.replace("/wallet_international");
                                        }
                                    })
                                }
                            }).catch(err => {
