...
export const BOTTOM_DEFAULT_CONFIG = {
  pullText: '上拉加载',
  triggerText: '释放更新',
  loadingText: '加载中...',
  doneText: '加载完成',
...
export const bodycontainer=$("#wallet_international");
  export default {
    name: 'vue-pull-to',
    props: {
      container: {
    ...
    computed: {
      ...
      totop:function(){
        return $("#wallet_international").position().top;
      }
    },
    watch: {
      state(val) {
    ...
    methods: {
     ...
     //   console.log(52222222431222);
      ...
      checkBottomReached(){
        ...
        //console.log($(".app-body>div").position().top+','+this.scrollEl.scrollTop+','+this.scrollEl.offsetHeight+','+this.scrollEl.scrollHeight);
        return this.scrollEl.scrollHeight+$(".app-body>div").position().top-$(".app-body").height()<10;
      ...
      handleTouchStart(event) {
        ...
        this.startScrollTop =$(".app-body>div").position().top;
        this.bottomReached = this.checkBottomReached();//是否到最底部
