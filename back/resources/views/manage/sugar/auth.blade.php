...
@section('container')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form id="search_form" action="{{url("sugar.auth")}}" method="GET" class="form-horizontal" role="form" >
                <div class="row">
                    <div class="col-md-2">
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-md-2">
                        <div class="input-group">
                            <button type="button" class="btn btn-primary" data-target="#myModal" data-toggle="modal">添加发糖资格人</button>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin-top: 20px;">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">添加发糖资格人</h4>
                    </div>
                        ...
                        <div style="padding: 10px 10px 10px;">
                            <form class="bs-example bs-example-form" role="form">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <span>发糖果时收取总额等额的{{db_config('COIN_UNIT')}}作为手续费，手续费比例：</span>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            <span>{{db_config('COIN_UNIT')}} 时，取消发糖资格</span>
                                        </div>
                                        <div class="col-xs-6"></div>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div style="padding: 10px 10px 10px;">
                            <form class="bs-example bs-example-form" role="form" id="edit_form">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <span>发糖果或转账时收取总额等额的{{db_config('COIN_UNIT')}}作为手续费，手续费比例：</span>
        ...
        <script>
            ...
            function detail(mobile) {
                var url ='{{url('sugar.log')}}'+'?from='+mobile+'&coin_type={{$param['coin_type']}}';
                location.href = url
            }
