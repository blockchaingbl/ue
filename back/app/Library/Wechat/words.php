...
class words
{
	...
	public static function segment($text,$num = 10)
	{
		...
		if(function_exists("scws_open"))
		{
			...
			scws_set_dict($sh,base_path('app/Library/Wechat/scws/dict.utf8.xdb'));
			scws_set_rule($sh,base_path('app/Library/Wechat/scws/rules.utf8.ini'));
		...
		{
			include(base_path('app/Library/Wechat/scws/pscws4.class.php'));
			$pscws = new PSCWS4();
			$pscws->set_dict(base_path('app/Library/Wechat/scws/dict.utf8.xdb'));
			$pscws->set_rule(base_path('app/Library/Wechat/scws/rules.utf8.ini'));
	...
	*/
	...
	public static function clearSymbol($str){
		static $symbols = null;
		if($symbols === null){
			$symbols = file_get_contents(base_path('app/Library/Wechat/scws/symbol.table'));
			$symbols = explode("\r\n",$symbols);
		}
